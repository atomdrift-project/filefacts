...
pub const CATALOG: &[&str] = &[
    "android.component_count",
    "android.debuggable",
    "android.exported_component_count",
    "android.manifest_unreadable",
    "android.min_sdk",
    "android.permission_count",
    "android.target_sdk",
    "android.v1_signature_count",
    "apk.declared_size",
    "apk.depend_count",
    "apk.signed",
    "apk.subpackage",
    ...
    "binds.count",
    "cab.data_block_count",
    "cab.data_reserve_size",
    "cab.declared_file_count",
    "cab.declared_folder_count",
    "cab.declared_total_size",
    "cab.exec_attribute_count",
    "cab.file_count_mismatch",
    "cab.folder_count",
    "cab.folder_reserve_size",
    "cab.has_next_cabinet",
    "cab.has_prev_cabinet",
    "cab.header_reserve_size",
    "cab.nonzero_reserved_count",
    "cab.post_signature_bytes",
    "cab.readonly_file_count",
    "cab.signature_bytes",
    "cab.system_file_count",
    "cab.utf8_name_count",
    ...
    "consistency.self_referential_git_dependency",
    "deb.depends_count",
    "deb.installed_size",
    "dependencies.count",
    ...
    "elf.entry_in_non_executable_segment",
    "elf.entry_in_nonstandard_section",
    "elf.entry_in_writable_segment",
    "elf.entry_outside_sections",
    "elf.entry_outside_segments",
    "elf.executable_segment_count",
    ...
    "elf.program_header_count_mismatch",
    "elf.relacount",
    "elf.rodata_writable",
    ...
    "elf.shstrndx_out_of_range",
    "elf.stack_canary",
    "elf.stripped_metadata_section_count",
    "elf.stripped_with_symtab",
    "elf.symtab_count",
    "elf.text_section_writable",
    "elf.uncovered_alloc_section_count",
    "elf.uncovered_note_count",
    "elf.wx_segment_count",
    "exports.api_count",
    "exports.count",
    "file.entropy",
    "file.size",
    "font.declared_size_delta",
    "font.gap_bytes",
    "font.largest_table_bytes",
    "font.leading_whitespace_bytes",
    "font.printable_ratio",
    "font.stowaway_bytes",
    "font.stowaway_entropy",
    "font.table_count",
    "font.trailing_bytes",
    "font.unknown_table_bytes",
    "font.unknown_table_count",
    "functions.anonymous",
    ...
    "jar.entry_count",
    "jar.index_count",
    "jar.manifest.attribute_count",
    "jar.manifest.boot_class_path_count",
    "jar.manifest.class_path_count",
    "jar.manifest.digest_count",
    "jar.manifest.entry_count",
    "jar.manifest.section_count",
    ...
    "macho.entry_in_nonstandard_section",
    "macho.entry_in_writable_segment",
    "macho.entry_outside_segments",
    "macho.executable_segment_count",
    ...
    "media.gap_bytes",
    "media.stowaway_bytes",
    "media.stowaway_entropy",
    "media.trailing_bytes",
    "nib.class_count",
    "nib.class_name_count",
    "nib.connection_count",
    "nib.object_count",
    "nib.string_count",
    "oci.image_count",
    "oci.layer_count",
    ...
    "pe.dos_stub_zeroed",
    "pe.entry_in_header",
    "pe.entry_in_nonstandard_section",
    ...
    "rar.acl_count",
    "rar.blake2_count",
    "rar.child_header_count",
    "rar.encrypted_header",
    "rar.end_present",
    "rar.file_version_count",
    "rar.header_crc_mismatch_count",
    "rar.kdf_count",
    "rar.locked",
    "rar.mapped_unix_name_count",
    "rar.ntfs_stream_count",
    "rar.quick_open",
    "rar.quick_open_size",
    "rar.recovery",
    "rar.recovery_size",
    "rar.service_header_count",
    "rar.sfx_bytes",
    "rar.solid",
    "rar.split_count",
    "rar.unknown_extra_count",
    "rar.unknown_header_count",
    "rar.v1_compression_count",
    "rar.volume",
    "registry.age_days",
